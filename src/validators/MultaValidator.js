...
const schema = yup.object().shape({
     ...
     valor: yup.number().required(),
        ...
        descricao: yup.string().required().min(50).max(100),
        dataOcorrencia: yup.date().required(),
        dataPagamento: yup.date().required(),
        status: yup.string().required(),
        funcionario: yup.string().required().teste("id-validator", "id do funcionário é inválido", (value) => mongoose.Types.ObjectId.isValid(value))
